  ...
  return (
    <view className="flex-1 flex flex-col items-center px-6 pt-6 pb-12 w-full max-w-[480px] mx-auto">
      ...
      <view className="w-full mb-10">
        <view className="flex h-12 flex-row w-full items-center rounded-xl bg-input-bg p-1 border border-border">
          <view
            className={`flex-1 h-full items-center justify-center rounded-lg ${role === 'Student' ? 'bg-primary' : ''}`}
            bindtap={() => handleRoleChange('Student')}
          >
            <text
              className={`font-semibold ${role === 'Student' ? 'text-white' : 'text-muted-foreground'}`}
            >
              Student
            </text>
          </view>
          ...
          >
            <text
              className={`font-semibold ${role === 'Admin' ? 'text-white' : 'text-muted-foreground'}`}
            >
              Admin
            </text>
          </view>
        ...
        <view className="gap-2">
          ...
          <view className="relative">
            <Input
              ...
              className="pl-12 bg-input-bg border-border rounded-2xl h-14 text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-primary/50 focus:border-primary/50"
            />
        ...
        <view className="gap-2">
          ...
          <view className="relative">
            <Input
              ...
              className="pl-12 pr-12 bg-input-bg border-border rounded-2xl h-14 text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-primary/50 focus:border-primary/50"
            />
            <text className="absolute left-4 top-4 text-muted-foreground">
              🔒
            </text>
      ...
      <view className="mt-14 flex flex-col items-center gap-6 w-full">
        ...
        <view className="flex flex-row gap-6">
          <view className="items-center justify-center size-16 rounded-2xl bg-input-bg border border-border active:bg-primary/10 active:scale-95 transition-all">
